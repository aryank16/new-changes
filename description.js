...
import PeriodicService from "../assets/PeriodicServices.png";
...
import denting  from "../assets/denting.jpeg";
import Windshield from "../assets/Windshield.webp";
import insurance from "../assets/insurance.png";
import roadside  from "../assets/roadside.jpg";
import accesories from "../assets/accesories.webp";
import detailing from "../assets/detailing.webp";
...
const Description = () => {
  ...
  return (
    ...
    <div class="des_card" onClick={togglePopup1}>
            <img src={PeriodicService} alt="Avatar" style={{ width: "80%", marginLeft: "5%", height: "200px" }} />
    ...
    <div class="des_card" onClick={togglePopup2}>
            <img src={tyre} alt="Avatar" style={{ width: "80%", marginLeft: "5%", height: "200px" }} />
            <div class="des_container">
    ...
    <div class="des_card" onClick={togglePopup4}>
            <img src={brake} alt="Avatar" style={{ width: "80%", marginLeft: "5%", height: "200px" }} />
            <div class="des_container">
    ...
    <div class="des_card" onClick={togglePopup5}>
            <img src={spa} alt="Avatar" style={{ width: "80%", marginLeft: "5%", height: "200px" }} />
            <div class="des_container">
    ...
    <div class="des_card" onClick={togglePopup6}>
            <img src={clutch} alt="Avatar" style={{ width: "80%", marginLeft: "5%", height: "200px" }} />
            <div class="des_container">
    ...
    <div class="des_card" onClick={togglePopup7}>
            <img src={batteries} alt="Avatar" style={{ width: "80%", marginLeft: "5%", height: "200px" }} />
            <div class="des_container">
              <h4><b>BATTERIES</b></h4>
              <br />
    ...
    <div class="des_card" onClick={togglePopup8}>
            <img src={denting} alt="Avatar" style={{ width: "80%", marginLeft: "5%", height: "200px" }} />
            <div class="des_container">
    ...
    <div class="des_card" onClick={togglePopup9}>
            <img src={Windshield} alt="Avatar" style={{ width: "80%", marginLeft: "5%", height: "200px" }} />
            <div class="des_container">
    ...
    <div class="des_card" onClick={togglePopup10}>
            <img src={insurance} alt="Avatar" style={{ width: "80%", marginLeft: "5%", height: "200px" }} />
            <div class="des_container">
              <h4><b>INSURANCE</b></h4>
              <br />
    ...
    <div class="des_card" onClick={togglePopup11}>
            <img src={roadside} alt="Avatar" style={{ width: "80%", marginLeft: "5%", height: "200px" }} />
            <div class="des_container">
    ...
    <div class="des_card" onClick={togglePopup12}>
            <img src={accesories} alt="Avatar" style={{ width: "80%", marginLeft: "5%", height: "200px" }} />
            <div class="des_container">
    ...
    <div class="des_card" onClick={togglePopup13}>
            <img src={detailing} alt="Avatar" style={{ width: "80%", marginLeft: "5%", height: "200px" }} />
            <div class="des_container">
    ...
    <div class="des_card" onClick={togglePopup15}>
            <img src={suspension} alt="Avatar" style={{ width: "80%", marginLeft: "5%", height: "200px" }} />
            <div class="des_container">
